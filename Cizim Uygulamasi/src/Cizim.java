...
public class Cizim extends JFrame implements MouseMotionListener,ActionListener {
   ...
   private JPanel paintPane;
    public Cizim() {
        ...
        white.addActionListener(this);  //Beyaz rengi silgi olarak kullandým.
     ...
     //
        ...
        if(act.equals("Mavi"))
            ...
            col = Color.WHITE;
        else//bunlardan biri deðilse renk siyah olsun
            col = Color.BLACK;
        }  
    ...
    public void mouseDragged(MouseEvent e) {
        x = e.getX(); y= e.getY();
        repaint();// özel parametre ile çaðrýlan çizim metodu
	...
	public void paintComponent(Graphics g) {// bu Kýsýmda kaydetme ile ilgili kýsým içine giriyor.
